...
/**
 * Handler for chat message length. Controls if the element \e elem exceeds \e limit chars.
 * If so it will just cut the last type char away.
...
/**
 * Handles the dynamic size of the page if the toggle buttons are pressed.
 * Will adjust style sheet according to user wishes what he wants to see (Chat,Queue).
 */
...
/**
 * Handles keystrokes which made on the clients keyboard.
 * Will only work if the chat is not in focus.
 */
